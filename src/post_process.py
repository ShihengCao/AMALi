...
def parse_out(app_name, front_keys=None):
    ...
    if front_keys is None:
        front_keys = ["kernel_id","kernel_name","AMALi","selected","wait","drain","long_scoreboard","short_scoreboard","math_pipe_throttle","lg_throttle","mio_throttle","S_MSHR_i","S_NoC_i","S_Dram_i","C_idle_i_ID","no_instructions_and_imc_miss","GCoM+TCM","GCoM+TCM+KLL"]
